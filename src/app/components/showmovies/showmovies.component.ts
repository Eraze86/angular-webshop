...
export class ShowmoviesComponent implements OnInit {
  ...
  ngOnInit() {
    this.service.products$.pipe(take(1)).subscribe((dataFromService: IData[]) => {
  ...
  // this.service.getAddMovie(this.addOrder.length);
  // localStorage.setItem("",JSON.stringify(this.addOrder))
